      ...
      <div class="mude_is_left">
        <el-card class="box-card">
          <div class="mude_text_item">
            <div class="descTItle">测评问题清单（盖章）</div>
            <el-form
              ref="assessmentGroup"
...
export default {
  ...
  methods: {
    async getEtlist() {
      ...
      this.assessmentGroup.reportName = `${this.xmu_info.data.evaluatedUnit}测评问题清单（盖章）`;
    ...
    async reportTimepdate() {
      ...
      if (res.data.manifestTime !== 0 && res.data.manifestTime !== null) {
        this.assessmentGroup.reportTime = res.data.manifestTime;
      }
    },
    async submitReport() {
      let url = `${process.env.VUE_APP_API}/word/reviseManifestStamp`;
      let data = {
        url: url,
        data: {
