    ...
    textChangeHandler(delta, oldDelta, source) {
     ...
     async getEtlist() {
      ...
      if (List.code === 20000) {
        ...
        对重点区的PC服务器，在系统运维管理中指定为专人运行维护，只有一个人可以使用该机器，主机系统上只有一个可以在本地登录的帐户。该机器在主机系统安全中的自主访问控制和资源控制虽然没有满足相应安全等级要求，但考虑到通过系统运维管理的加强可以增强主机系统这方面安全功能。因此，可以适当降低自主访问控制和资源控制的要求，主机系统在总体的安全功能上也不会受到影响，仍能满足相应等级的安全要求。
            </pre>`
        }else{
