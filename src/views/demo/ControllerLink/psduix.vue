...
export default {
  ...
  methods: {
    ...
    this.fromdata.objSelectionMethod = `    结合生产制造执行系统的网络拓扑结构和业务情况，本次测评的对象包括物理机房、网络设备、安全设备、服务器设备、终端设备、业务应用系统、数据对象、管理体系和人员等。通过综合考虑安全保护等级、业务应用特点和具体设备的重要情况等要素选择测评对象。`;
        }
        let tools = [];
