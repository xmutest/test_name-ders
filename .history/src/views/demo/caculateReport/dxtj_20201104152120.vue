      ...
      for(let i=0;i<imitateData.length;i++){
        ...
        for(let j=0;j<list.resultData.length;j++){
          ...
          for(let k=0;k<item.sceneCheckData.length;k++){
            let value = item.sceneCheckData[k],secondName = value.safetyControlSpot,params = {}
            // debugger
            if(k == 0) params.rowspan = item.sceneCheckData.length
            ...
            for(let n=0;n<value.controlEntriesData.length;n++){
              ...
              params.name = pre.controlEntries,
              params.objCount = pre.objCount,
              params.accord = pre.accord,
              params.sectionAccord = pre.sectionAccord,
              params.notAccord = pre.notAccord,
              params.notBeApplicable = pre.notBeApplicable
